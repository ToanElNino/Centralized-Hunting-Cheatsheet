# QUY TRÌNH CA TẬP TRUNG

## 1. QUY TRÌNH VẬN HÀNH HỆ THỐNG CA TẬP TRUNG

### 1.1. Quy trình quản lý máy chủ Esxi

### 1.2. Quy trình dựng máy chủ Esxi

### 1.3. Quy trình quản lý và backup máy ảo Esxi

---

## 2. QUY TRÌNH THỰC HIỆN DỰ ÁN CA TẬP TRUNG
...
## 2.1. Khởi tạo tài liệu cho dự án
...
### 2.1.1. Tạo Centrailzed Hunting Note
...
### 2.1.2.  Tạo dự án trên DFIR Platform (To be determined)
---

## 2.2. Thu thập log và thông tin thiết bị cho dự án

### 2.1.2. Thu thập log từ endpoint

### 2.2.2. Copy log vào máy chủ Hunting tập trung
...
## 2.3.1. Tiền xử lý log cho Windows
...
### 2.3.2. Tiền xử lý log cho Linux
...
### 2.3.3. Kiểm tra log upload Splunk
...
# 2.4. Tiến hành hunting tập trung
...
## 2.4.1. Hunting tập trung cho Windows
...
### 2.4.2. Hunting tập trung cho Linux

## 2.5. Đánh giá hiệu năng và cải tiến

### 2.5.1. Thu thập và đánh giá hiệu năng

### 2.5.2. Hướng dẫn contribute vào Hunting Group
